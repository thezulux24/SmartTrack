    ...
    <div 
      ...
      <div class="bg-white -mt-12 mx-4 rounded-2xl shadow-lg p-6 relative z-10 border border-gray-100">
        <div class="text-center">
          ...
          <div class="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-[#0098A8]/10 to-[#C8D900]/10 rounded-full">
            <div class="w-2 h-2 bg-[#0098A8] rounded-full"></div>
            <span class="text-sm font-semibold text-[#10284C]">
              {{ getRoleDisplay() }}
            </span>
          </div>
        </div>
      ...
      <div class="flex-1 overflow-y-auto p-4">
        <div class="space-y-2">
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors group">
            <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-[#0098A8] to-[#0098A8]/80 flex items-center justify-center">
              <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
              </svg>
            </div>
            <div class="flex-1 text-left">
              <p class="text-sm font-semibold text-gray-900 group-hover:text-[#0098A8]">Mi Perfil</p>
              <p class="text-xs text-gray-500">Editar información</p>
            </div>
            <svg class="w-5 h-5 text-gray-400 group-hover:text-[#0098A8] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors group">
            <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-[#C8D900] to-[#C8D900]/80 flex items-center justify-center">
            ...
            <div class="flex-1 text-left">
              <p class="text-sm font-semibold text-gray-900 group-hover:text-[#0098A8]">Configuración</p>
          ...
          <button 
            ...
            class="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors group">
            <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-[#10284C] to-[#10284C]/80 flex items-center justify-center">
              <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
              </svg>
            </div>
            <div class="flex-1 text-left">
              <p class="text-sm font-semibold text-gray-900 group-hover:text-[#0098A8]">Notificaciones</p>
          ...
          <button 
            ...
            <div class="flex-1 text-left">
              <p class="text-sm font-semibold text-gray-900 group-hover:text-[#0098A8]">Ayuda y Soporte</p>
      ...
      <div class="p-4 border-t border-gray-200 bg-gray-50">
        <button 
          (click)="logout()"
          class="w-full flex items-center justify-center gap-3 p-3 rounded-xl bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02]">
